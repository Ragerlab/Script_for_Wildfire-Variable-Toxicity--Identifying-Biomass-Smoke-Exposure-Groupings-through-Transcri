...
# ggsave("figures/24h_optimal_clusters_gene_wss_FC_2.png", height=10, width=16, unit="in",plot=wssplot_gene)
# Sys.time()
...
# ggsave("figures/24h_optimal_clusters_gene_silhouette_FC_2.png", height=10, width=16, unit="in",plot=silhoplot_gene)
# Sys.time()
...
#Select 33 clusters and get cluster assignment for each gene
ncut_gene <- 33
...
#Make heatmap
pheatmap(hm_data, main="24h (padj<0.1 & |FC|>=2)",
         cluster_rows=FALSE,
         cluster_cols = FALSE,
         show_rownames = TRUE,
         show_colnames = FALSE,
         ...
         filename = "figures/24h_omics_heatmap_FC_2.png",
         height = 24,
         width = 36,
         border_color = NA)
...
write_csv(final_tab, "output/24h_similarity_lower_tri_FC_2.csv")
