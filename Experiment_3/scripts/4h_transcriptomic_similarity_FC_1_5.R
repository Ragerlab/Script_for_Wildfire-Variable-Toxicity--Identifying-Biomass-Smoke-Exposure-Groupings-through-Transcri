...
# ggsave("figures/4h_optimal_clusters_gene_wss_FC_1_5.png", height=10, width=16, unit="in",plot=wssplot_gene)
# Sys.time()
...
# ggsave("figures/4h_optimal_clusters_gene_silhouette_FC_1_5.png", height=10, width=16, unit="in",plot=silhoplot_gene)
# Sys.time()
...
#Select 56 clusters and get cluster assignment for each gene
ncut_gene <- 56
...
#Make heatmap
pheatmap(hm_data, main="4h (padj<0.1 & |FC|>=1.5)",
         cluster_rows=FALSE,
         cluster_cols = FALSE,
         show_rownames = TRUE,
         show_colnames = FALSE,
         ...
         filename = "figures/4h_omics_heatmap_FC_1_5.png",
         height = 24,
         width = 36,
         border_color = NA)
...
write_csv(final_tab, "output/4h_similarity_lower_tri_FC_1_5.csv")
